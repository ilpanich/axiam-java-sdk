...
public enum CertificateType {
    /** The server's 'User' value. */
    USER("User"),
    /** The server's 'Service' value. */
    SERVICE("Service"),
     ...
     * @return the matching CertificateType
     * @throws IllegalArgumentException if no constant carries that spelling
     */
    @JsonCreator
    public static CertificateType fromWire(String value) {
        for (CertificateType candidate : values()) {
            if (candidate.wire.equals(value)) {
                return candidate;
            }
        }
        throw new IllegalArgumentException("unknown CertificateType value: " + value);
    }
}
