...
public enum PgpKeyAlgorithm {
     ...
     * @return the matching PgpKeyAlgorithm
     * @throws IllegalArgumentException if no constant carries that spelling
     */
    @JsonCreator
    public static PgpKeyAlgorithm fromWire(String value) {
        for (PgpKeyAlgorithm candidate : values()) {
            if (candidate.wire.equals(value)) {
                return candidate;
            }
        }
        throw new IllegalArgumentException("unknown PgpKeyAlgorithm value: " + value);
    }
}
