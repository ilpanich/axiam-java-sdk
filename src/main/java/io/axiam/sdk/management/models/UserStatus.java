...
public enum UserStatus {
    ...
    ACTIVE("Active"),
    /** The server's 'Inactive' value. */
    INACTIVE("Inactive"),
    /** The server's 'Locked' value. */
    LOCKED("Locked"),
    /** The server's 'PendingVerification' value. */
    PENDING_VERIFICATION("PendingVerification"),
    /** The server's 'Anonymized' value. */
    ANONYMIZED("Anonymized"),
    /** The server's 'Deleted' value. */
    DELETED("Deleted"),
    /**
     ...
     * @return the matching UserStatus, or {@link #UNKNOWN}
     */
    @JsonCreator
