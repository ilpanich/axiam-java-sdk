...
public enum ActorType {
    ...
    USER("User"),
    /** The server's 'ServiceAccount' value. */
    SERVICE_ACCOUNT("ServiceAccount"),
    /** The server's 'System' value. */
    SYSTEM("System"),
    /**
     ...
     * @return the matching ActorType, or {@link #UNKNOWN}
     */
    @JsonCreator
    public static ActorType fromWire(String value) {
        for (ActorType candidate : values()) {
