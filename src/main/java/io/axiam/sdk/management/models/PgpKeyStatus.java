...
public enum PgpKeyStatus {
     ...
     * @return the matching PgpKeyStatus
     * @throws IllegalArgumentException if no constant carries that spelling
     */
    @JsonCreator
    public static PgpKeyStatus fromWire(String value) {
        for (PgpKeyStatus candidate : values()) {
            if (candidate.wire.equals(value)) {
                return candidate;
            }
        }
        throw new IllegalArgumentException("unknown PgpKeyStatus value: " + value);
    }
}
