...
public enum CertificateStatus {
    ...
    ACTIVE("Active"),
    /** The server's 'Revoked' value. */
    REVOKED("Revoked"),
    /** The server's 'Expired' value. */
    EXPIRED("Expired");

    /** The spelling this value has on the wire. */
    private final String wire;

    CertificateStatus(String wire) {
        this.wire = wire;
    }
     ...
     * @return the matching CertificateStatus
     * @throws IllegalArgumentException if no constant carries that spelling
     */
    @JsonCreator
    public static CertificateStatus fromWire(String value) {
        for (CertificateStatus candidate : values()) {
            if (candidate.wire.equals(value)) {
                return candidate;
            }
        }
        throw new IllegalArgumentException("unknown CertificateStatus value: " + value);
    }
}
