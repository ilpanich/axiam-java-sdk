...
public enum UnknownAaguidAction {
    ...
    UnknownAaguidAction(String wire) {
        this.wire = wire;
    }
     ...
     * @return the matching UnknownAaguidAction
     * @throws IllegalArgumentException if no constant carries that spelling
     */
    @JsonCreator
    public static UnknownAaguidAction fromWire(String value) {
        for (UnknownAaguidAction candidate : values()) {
            if (candidate.wire.equals(value)) {
                return candidate;
            }
        }
        throw new IllegalArgumentException("unknown UnknownAaguidAction value: " + value);
    }
}
