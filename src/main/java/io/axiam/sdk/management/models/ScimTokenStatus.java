...
public enum ScimTokenStatus {
     ...
     * @return the matching ScimTokenStatus
     * @throws IllegalArgumentException if no constant carries that spelling
     */
    @JsonCreator
    public static ScimTokenStatus fromWire(String value) {
        for (ScimTokenStatus candidate : values()) {
            if (candidate.wire.equals(value)) {
                return candidate;
            }
        }
        throw new IllegalArgumentException("unknown ScimTokenStatus value: " + value);
    }
}
